    ...
    async def generate_exercise(
        ...
        try:
            ...
            result = await self.graph.ainvoke(
                initial_state,
                config={"configurable": {"thread_id": f"exercise_{concept_id}_{student_id}"}}
            )
    ...
    async def evaluate_exercise(
        ...
        try:
            ...
            return {
                ...
                "remediation": result.get("remediation_content") if result.get("needs_remediation") else None
            }
