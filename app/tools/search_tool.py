...
class SearchTool:
    ...
    async def search_concept_definitions(
        self, concept_name: str, limit: int = 3
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(
                "Concept definition search failed", concept=concept_name, error=str(e)
            )
            return {
                "success": False,
                "error": str(e),
    ...
    async def search_examples(
        self, concept_name: str, context: str = "", limit: int = 3
    ) -> Dict[str, Any]:
        """
    ...
    async def search_step_by_step_guides(
        self, concept_name: str, difficulty: str = "basic", limit: int = 2
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(
                "Step-by-step guide search failed", concept=concept_name, error=str(e)
            )
            return {
                "success": False,
                "error": str(e),
    ...
    async def search_common_mistakes(
        self, concept_name: str, limit: int = 3
    ) -> Dict[str, Any]:
        """
        ...
        try:
            query = (
                f"common mistakes errors misconceptions {concept_name} wrong typical"
            )
            results = await self.pinecone_service._search_content_service(
            ...
            logger.error(
                "Common mistakes search failed", concept=concept_name, error=str(e)
            )
            return {
                "success": False,
                "error": str(e),
    ...
    async def search_verification_methods(
        self, concept_name: str, limit: int = 2
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(
                "Verification methods search failed", concept=concept_name, error=str(e)
            )
            return {
                "success": False,
                "error": str(e),
    ...
    async def comprehensive_search(
        ...
        try:
            ...
            logger.error(
                "Comprehensive search failed", concept=concept_name, error=str(e)
            )
            return {"success": False, "error": str(e), "concept": concept_name}

    async def search_for_prompt_enhancement(
        self, base_query: str, enhancement_type: str = "context"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(
                "Prompt enhancement search failed", query=base_query, error=str(e)
            )
            return {
                "success": False,
                "error": str(e),
